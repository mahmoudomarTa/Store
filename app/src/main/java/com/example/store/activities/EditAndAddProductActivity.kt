    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // TODO : load object from firebase
            ...
            btnSaveProduct.setOnClickListener {
                ...
                var product =Product(System.currentTimeMillis().toString(),name,description,price,rate,discount,System.currentTimeMillis(),"","",category!!,false,lat,long)
                db.collection("categories").document(product.category).collection("products")
                    .add(product)
